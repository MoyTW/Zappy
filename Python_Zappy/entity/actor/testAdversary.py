...
class TestAdversary(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.adversary = Adversary.Adversary(_eid=99, _level=self.level.view, _senses=[SenseSeismic.SenseSeismic(5)],
    ...
    def test_select_target(self):
        ...
        self.high_threat = Adversary.Adversary(_eid=98, _level=self.level, _faction=FACTIONS.TEST_1, _base_threat=5)
        self.no_threat = Adversary.Adversary(_eid=97, _level=self.level, _faction=FACTIONS.TEST_1, _base_threat=0)
